...
find . -type f -exec sed -i '' -e "s/Abdalrahman/$author_name/g" {} \;
find . -type f -exec sed -i '' -e "s/AbdalrahmanAlmesery/$author_username/g" {} \;
find . -type f -exec sed -i '' -e "s/36532405+almesery@users.noreply.github.com/$author_email/g" {} \;
